"""RFC 9728 Protected Resource Metadata and 401 challenge, driven through the
streamable-HTTP ASGI app exactly as the Claude Directory will see them."""
...
from tests.conftest import MCP_HEADERS
...
_AUTH_ENV_KEYS = (*OAUTH_ENV, "MCP_OAUTH_AUDIENCE")
